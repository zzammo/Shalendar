...
class TimeTableCustomView : BaseTimeTable {

    val timetable: LinearLayout by lazy {
        findViewById(com.islandparadise14.mintable.R.id.timetable)
    }
    val leftMenu: LinearLayout by lazy {
        findViewById(com.islandparadise14.mintable.R.id.leftMenu)
    }
    val topMenu: LinearLayout by lazy {
        findViewById(com.islandparadise14.mintable.R.id.topMenu)
    }
    val mainTable: FrameLayout by lazy {
        findViewById(com.islandparadise14.mintable.R.id.mainTable)
    }
    val borderBox: LinearLayout by lazy {
        findViewById(com.islandparadise14.mintable.R.id.borderBox)
    }
    val zeroPoint: LinearLayout by lazy {
        findViewById(com.islandparadise14.mintable.R.id.zeroPoint)
    }
    val timeCell: LinearLayout by lazy {
        findViewById(com.islandparadise14.mintable.R.id.timeCell)
    }
