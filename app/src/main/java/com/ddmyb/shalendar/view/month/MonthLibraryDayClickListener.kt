...
interface MonthLibraryDayClickListener {
    fun click(year: Int, month: Int, day: Int, scheduleList: MutableList<ScheduleDto>)
    fun doubleClick(year: Int, month: Int, day: Int, scheduleList: MutableList<ScheduleDto>)
}